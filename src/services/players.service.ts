...
export class PlayersService {
  ...
  private _url2 = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode + '&season=2019&hydrate=stats(type=season,season=2019,gameType=F)';
  ...
  async getIdsJSON() {
    ...
    const getPlayerByCountry = async (country) => {
      ...
      const response: any = await this.http.get('https://statsapi.mlb.com/api/v1/sports/1/players?season=2020&gameType=F').toPromise();
