...
650333, 623993, 591971, 570717,
446653, 541650, 642731, 542364, 614179,
...
517369,
  ...
  private _url6 = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode +  '&season=2019&hydrate=stats(type=gameLog,gameType=F)';
