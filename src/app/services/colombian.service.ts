...
import _ColombianPlayersCodes from '../../assets/JSONS/colombiansPlayersIds';


@Injectable({
  providedIn: 'root'
})
export class ColombianService {
  playerCode = 642715;
  // public venezuelanPlayersCodes;
  public ColombianPlayersCodes;
  private gameCode = [
    531368,
  ];
  ...
  private _url = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode + '&season=2023&hydrate=stats(type=season,season=2023,gameType=R)';
  ...
  constructor(private http: HttpClient) {
    ...
    this.ColombianPlayersCodes = _ColombianPlayersCodes;
  ...
  getAllDominicanPlayersActives(): Observable<StatsDayliPlayer | undefined>[] {
    ...
    for (let code of this.ColombianPlayersCodes) {
