...
export class PitchersService {
  ...
  private _url2 = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode + '&season=2021&hydrate=stats(group=pitching,type=season,season=2021,gameType=R)';
