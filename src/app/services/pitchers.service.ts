...
export class PitchersService {
  ...
  private _url = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode + '&season=2022&hydrate=stats(group=pitching,type=season,season=2022,gameType=S)';
  ...
  private _url2 = 'https://statsapi.mlb.com/api/v1/people?personIds=' + this.playerCode + '&season=2022&hydrate=stats(group=pitching,type=season,season=2022,gameType=s)';
