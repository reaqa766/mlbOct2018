...
export class AllplayersService {
  ...
  private playersCode = [
    ...
    542255, 444482, 500871, 506702,
    593958, 471911, 527048, 433589, 622694,
    621237, 630023, 521655, 491646, 434671,
    553878, 501625, 468504, 545121,
    448855, 641154, 608566, 591741,
    622608, 517369, 444468, 545064,
    642731, 553869, 650382, 650333
  ];

  // menores 2019 545121,658648, 602074, 650671, 514888,
  // 408234, 433217, 444482, 444489, 445988, 446653,  471865,
  // 452678, 455139, 462101, 463610, 465041, 467055,
  // 467092,  485567, 492802, 500208, 500743, 433587,
  // 500871, 500874, 501303, 503556,   491696,  622682,
  ...
  // 575929, 578570, 591712, 591720, 591741, 621592,
  // 593993, 596059, 600524, 600858, 602922,  591693,
  //  606115, 606299, 614179, 620439, 605612,
  // 622758, 501593, 623993,
