...
@Component({
  selector: 'app-quepasohoy',
  templateUrl: './quepasohoy.component.html',
  styleUrls: ['./quepasohoy.component.css']
})
export class QuepasohoyComponent implements OnInit {
  public players = [];
  groups: any;
  selectedGroup: any;
  elarray: any;
  ...
  diaAnterior = moment(this.diaAnt).subtract(1, 'day').format('DD-MM')
