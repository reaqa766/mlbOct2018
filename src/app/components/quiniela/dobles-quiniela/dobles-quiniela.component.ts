...
export class DoblesQuinielaComponent implements OnInit {
  ...
  EQUIPOS = [
    ...
    { code: 3, totalDiario:0, name: 'La Familia', liga: 'Norte', jugadores:[
      545361,594798,596019,641355,608070,453286,543685,607208,
      645277,502110,624424,521230,621242,641598,] },
    { code: 4, totalDiario:0, name: 'Los Quintereños', liga: 'Norte', jugadores:[
      665742,624413,521692,514888,408234,650402,623993,666200,542303,
      641154,547943,622694,665926,570482,] },
    { code: 5, totalDiario:0, name: 'Perfume Fe y Alegria', liga: 'Norte', jugadores:[
      665487,592663,518934,592450,668227,605483,502671,
      608337,446372,457708,553902,425794,518626,621043,] },
    { code: 6, totalDiario:0, name: 'The Lyons', liga: 'Norte', jugadores:[
      6543037,545333,547180,608369,547989,608324,575929,595879,
      624585,608331,544931,592206,541645,5519203, ] },
    { code: 7, totalDiario:0, name: 'Team Alcala', liga: 'Sur', jugadores:[
      606115,622694,656427,592626,628317,669374,663656,458681,
      656305,621566,593934,646240,668227,544931,593428,425877,670541,  ] },
    { code: 8, totalDiario:0, name: 'Super Leones', liga: 'Sur', jugadores:[
      547180,596019,608566,547989,514888,608070,623352,665742,
      650333,545361,669456,660271,621111,575929, ] },
    { code: 9, totalDiario:0, name: 'Michis Club', liga: 'Sur', jugadores:[
      547973,477132,553993,665487,519317,650402,
      543510,502110,456501,408234,605141,669242,665489,425844, ] },
    { code: 10, totalDiario:0, name: 'Las Vegas', liga: 'Sur', jugadores:[
      608369,592885,543807,543037,592663,608336,445276, 
      592518,453286,645277,502671,660670,545333,596115,] },
    ...
    { code: 12, totalDiario:0, name: 'Zamuros', liga: 'Sur', jugadores:[
      592450,519203,605483,453568,641355,659275,518934,518692,
      594798,595879,542303,571448,521692,506433, ] },
    { code: 13, totalDiario:0, name: 'Los Frailes', liga: 'Este', jugadores:[
      543685,664040,547180,592885,665487,543037,547943,
      608336,547989,592178,608337,608331,571976,518735,               ] },
    { code: 14, totalDiario:0, name: 'The Bay', liga: 'Este', jugadores:[
      592450,608324,605483,595879,621244,592663,457759,445276,
      542303,453286,488726,545361,656555,596115, ] },
    { code: 15, totalDiario:0, name: 'Robaseñas', liga: 'Este', jugadores:[
      547973,621043,572971,596142,519317,650402,594798,514888,
      621566,621242,571448,624413,668227,660670, ] },
    { code: 16, totalDiario:0, name: 'Toros de Pedregal', liga: 'Este', jugadores:[
      514917,477132,596019,665742,628317,592518,
      592206,666915,657656,660271,545333,665489,575929,506433, ] },
    { code: 17, totalDiario:0, name: 'KenGriffeyJr', liga: 'Este', jugadores:[
      605540,518692,656427,608070,663656,673357,
      605141,669456,609275,641313,621111,593160,669257,593428, ] },
    { code: 18, totalDiario:0, name: 'Diablos Rojos', liga: 'Este', jugadores:[
      605400,657077,543272,641355,608369,518934,543807,570482,
      571771,458681,571970,607192,663611,521692, ] }
  ];
