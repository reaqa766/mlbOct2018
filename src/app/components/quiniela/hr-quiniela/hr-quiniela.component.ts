...
export class HrQuinielaComponent implements OnInit {
  ...
  EQUIPOS = [
    { code: 1, totalDiario:0, name: 'Toros de Carabobo', liga: 'Norte', jugadores:[
      660670,542583,666969,668804,650644,641857,669257,592836,593428,493329,
    ...
    { code: 6, totalDiario:0, name: 'The Lyons', liga: 'Norte', jugadores:[
      543037,545333,656775,624428,666182,608324,547989,
      488726,607192,575929,592206,592332,547180,595879, ] },
    ...
    { code: 8, totalDiario:0, name: 'Super Leones', liga: 'Sur', jugadores:[
      ...
      606299,608385,669456,660271,621111,575929,554430, ] },
    ...
    { code: 15, totalDiario:0, name: 'Robaseñas', liga: 'Este', jugadores:[
      592836,665120,519317,425877,621566,594798,514888,
      542583,571448,624413,660670,607074,543063,605540, ] },
    ...
    { code: 17, totalDiario:0, name: 'KenGriffeyJr', liga: 'Este', jugadores:[
      621550,666201,641857,518735,641933,664062,621121,
      605141,621439,608070,621111,518692,666182,645277,  ] },
