...
export class Playerinfo2019Component implements OnInit { public players = [];
  public playersSort = [];
  ...
  constructor(private playerService: Players2019Service, private pagerService: PagerService, private route: ActivatedRoute) { }
