...
@Component({
  selector: 'app-resultados-teams-ayer',
  templateUrl: './resultados-teams-ayer.component.html',
  styleUrls: ['./resultados-teams-ayer.component.css']
})
export class ResultadosTeamsAyerComponent implements OnInit {dia = moment().format('YYYY-MM-DD');
